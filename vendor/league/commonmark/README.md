...
To report a security vulnerability, please use the [Tidelift security contacto](https://tidelift.com/security). Tidelift will coordinate the fix and disclosure with us.
