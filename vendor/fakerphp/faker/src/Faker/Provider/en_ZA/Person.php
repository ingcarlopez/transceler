...
class Person extends \Faker\Provider\Person
{
    ...
    protected static $firstNameMale = [
        ...
        'Xolani', 'Yusuf', 'andries', 'barend', 'contacto', 'dumisani', 'jacobus', 'kabelo', 'kagiso', 'karabo', 'lesego', 'marthinus',
        ...
        'Andries', 'Babalwa', 'Barend', 'Bulelwa', 'Contacto ', 'Dumisani', 'Fikile', 'Jacobus', 'Kabelo', 'Kagiso', 'Karabo', 'Kelebogile', 'Lesego',
