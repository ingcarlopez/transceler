...
EOT;
    ...
    *** END OF THE PROJECT GUTENBERG EBOOK SKLEPY CYNAMONOWE ***
    ...
    and clientes in: Alabama, Alaska, Arkansas, Connecticut,
    ...
    Contacto us if you want to arrange for a wire transfer or payment
    method other than by check or money order.

    The Project Gutenberg Literary Archive Foundation has been approved by
    the US Internal Revenue Service as a 501(c)(3) cliente with EIN
    ...
    *BEFORE!* YOU USE OR READ THIS EBOOK
    ...
    [3]  Pay a trademark license fee to the Foundation of 20% of the
         ...
         periodic) tax return.  Please contacto us beforehand to
    ...
    software or other items, please contacto Michael Hart at:
    hart@pobox.com
