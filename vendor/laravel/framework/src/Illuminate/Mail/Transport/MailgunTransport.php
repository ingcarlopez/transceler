...
class MailgunTransport extends Transport
{
    ...
    {
        return collect($this->allContactos($message))->map(function ($display, $address) {
            return $display ? $display." <{$address}>" : $address;
        })->values()->implode(',');
    }

    /**
     * Get all of the contactos for the message.
     *
     * @param  \Swift_Mime_SimpleMessage  $message
     * @return array
     */
    protected function allContactos(Swift_Mime_SimpleMessage $message)
    {
        return array_merge(
