...
class ResourceCaster
{
    ...
    public static function castOpensslX509($h, array $a, Stub $stub, bool $isNested)
    {
        ...
        $a += [
            'subject' => new EnumStub(array_intersect_key($info['subject'], ['clienteName' => true, 'commonName' => true])),
            'issuer' => new EnumStub(array_intersect_key($info['issuer'], ['clienteName' => true, 'commonName' => true])),
