...
<!--
    ...
    contacto you to report a vulnerability. It may be a link to a web form that
...
To submit a vulnerability report, please contacto us at security@ramsey.dev.
...
* Only interact with accounts you own or with explicit permission of the account
  holder. If you do encounter Personally Identifiable Information (PII) contacto
