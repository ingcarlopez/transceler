<template>
  <Head title="Login" />
  <div class="flex items-center justify-center p-6 min-h-screen bg-rose-800">
    <div class="w-full max-w-md">
      ...
      <form class="mt-8 bg-white rounded-lg shadow-xl overflow-hidden" @submit.prevent="login">
        ...
        <div class="flex px-10 py-4 bg-gray-100 border-t border-gray-100">
          <loading-button :loading="form.processing" class="btn-rose ml-auto" type="submit">Entrar</loading-button>
        </div>
      </form>
    </div>
  </div>
